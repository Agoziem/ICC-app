...
export const organizationSchema = z.object({
  ...
  address: z.string(),
  whatsapplink: z.string().url().max(200).optional().nullable(),
  facebooklink: z.string().url().max(200).optional().nullable(),
  instagramlink: z.string().url().max(200).optional().nullable(),
  twitterlink: z.string().url().max(200).optional().nullable(),
  tiktoklink: z.string().url().max(200).optional().nullable(),
  linkedinlink: z.string().url().max(200).optional().nullable(),
  youtubechannel: z.string().url().max(200).optional().nullable(),
